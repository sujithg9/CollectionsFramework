...
public class SortingListsUsingComparators {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Animal sorted in Reverse Order: ");
        ...
        people.add(new Persons(1, "Joe"));
        people.add(new Persons(3, "Bob"));
        people.add(new Persons(4, "Clare"));
        people.add(new Persons(2, "Sue"));
        ...
        System.out.println("Persons sorted with Id: "); 
